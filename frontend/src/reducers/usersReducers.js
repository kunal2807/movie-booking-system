...
export const userLoginReducer = (state = { product: { reviews: [] } },
    action) => {
    switch (action.type) {
...
export const userRegisterReducer = (state = { product: { reviews: [] } },
    action) => {
    switch (action.type) {
...
export const userDetailsReducer = (state = { product: { reviews: [] } },
    action) => {
    switch (action.type) {
